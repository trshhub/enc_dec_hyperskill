class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        LaptopStore laptopStore = /* write your code here */ new LaptopStore();
...
class LaptopStore extends LaptopFactory {
    ...
    Laptop createLaptop(String type) {
        switch (type) {
            case "13 inch":
                return /* write your code here */ new Laptop13("13 inch Laptop");
            case "15 inch":
                return /* write your code here */ new Laptop15("15 inch Laptop");
            case "17 inch":
                return /* write your code here */ new Laptop17("17 inch Laptop");
            default:
                return null;
        }
    }
