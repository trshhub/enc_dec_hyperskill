class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        //burgerStore.createBurger("Chinese");
        Burger burger1 = burgerStore.orderBurger("Chinese");
        Burger burger2 = burgerStore.orderBurger("American");
        Burger burger3 = burgerStore.orderBurger("Russian");
    }
}
...
class BurgerStore extends BurgerFactory {
    ...
    Burger createBurger(String type) {
        switch (type) {
            case /* write your code here */ "Chinese" :
                return new ChineseBurger("Chinese Burger");
            case /* write your code here */ "American" :
                return new AmericanBurger("American Burger");
            case /* write your code here */ "Russian" :
